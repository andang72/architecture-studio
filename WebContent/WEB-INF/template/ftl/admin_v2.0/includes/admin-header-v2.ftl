					...
					<div class="g-pos-rel g-px-10--lg">
						<a id="profileMenuInvoker" class="d-block" href="#!"
							...
							<span class="g-pos-rel"> 
								...
								<img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle g-mr-10--sm" data-bind="attr:{ src: userAvatarSrc  }" src="<@spring.url "/images/no-avatar.png"/>" alt="Image description">
							</span> 
							<span class="g-pos-rel g-top-2"> 
								<span class="g-hidden-sm-down" data-bind="text:userDisplayName"></span> <i class="hs-admin-angle-down g-pos-rel g-top-2 g-ml-10"></i>
							</span>
						</a>
						...
						<ul id="profileMenu" class="g-pos-abs g-left-0 g-width-150x--lg g-nowrap g-font-size-14 g-py-20 g-mt-17 rounded u-dropdown--css-animation u-dropdown--hidden" aria-labelledby="profileMenuInvoker" style="animation-duration: 300ms;">
							...
							<li class="g-mb-10">
								<a class="media g-color-lightred-v2--hover g-py-5 g-px-20" data-page="none" href="profile" > 
									<span class="d-flex align-self-center g-mr-12">
